        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>List of Admins and Standard Users</h5>
    ...
    <div class="modal-dialog">
        <form id="editUserForm">
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-white" data-dismiss="modal" id='closeUserModal'>Close</button>
                    <button type="submit" id="editUserDataBtn" class="btn btn-primary">Save changes</button>
...
<script>
    $(document).ready(function() {
        ...
        $("#addUserForm").validate({
            ...
            messages:{
                addRole: {
                    min: "Please select a value for user role",
                },
            },
            submitHandler: function(form) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?= base_url() . 'index.php/usermanagement/addUser' ?>",
                    data: data,
        ...
        $("#editUserForm").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?= base_url() . 'index.php/usermanagement/updateUserData' ?>",
                    data: data,
                    success: function(response) {
    ...
    function blockUser(id, status) {
        $.ajax({
            method: "GET",
            url: "<?= base_url() . 'index.php/usermanagement/blockUserData' ?>",
            data: {
                "id": id,
                "status": status
            },
    ...
    function getAlluserData() {
        ...
        $.ajax({
            method: "GET",
            url: "<?= base_url() . 'index.php/usermanagement/getAlluserData' ?>",
            success: function(response) {
    ...
    function deleteUser(id) {
        swal({
            ...
            $.ajax({
                method: "GET",
                url: "<?= base_url() . 'index.php/usermanagement/deleteUserData' ?>",
                data: {
                    "id": id
                },
                success: function(response) {
    ...
    function editUser(id) {
        ...
        $.ajax({
            method: "GET",
            url: "<?= base_url() . 'index.php/usermanagement/getUserData' ?>",
            data: {
                "id": id
            },
            dataType: 'json',
